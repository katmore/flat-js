...
(function() {
   ...
   if ( (flat === null || typeof flat !== 'object') ||  typeof(flat.load) != 'function') {
      throw new Error("flat/loadingOverlay: missing flat-js");
   }
   
   if (!jQuery) throw new Error("flat/loadingOverlay: missing jQuery");
   ...
   flat.load('loadingOverlay',loadingOverlay);
